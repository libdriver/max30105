...
LibDriver MAX30105是LibDriver推出的MAX30105的全功能驱动，该驱动提供FIFO读取，ID读取等功能。
...
/src目录包含了LibDriver MAX30105的源文件。

/interface目录包含了LibDriver MAX30105与平台无关的IIC总线模板。

/test目录包含了LibDriver MAX30105驱动测试程序，该程序可以简单的测试芯片必要功能。

/example目录包含了LibDriver MAX30105编程范例。

/doc目录包含了LibDriver MAX30105离线文档。

/datasheet目录包含了MAX30105数据手册。
...
在线文档: https://www.libdriver.com/docs/max30105/index.html
